<?php
// Archivo simplificado para gestión de comentarios (sin verificación de sesión)
...
function aprobarComentario() {
    ...
    if ($id <= 0) {
        throw new Exception('ID de comentario inválido. ID recibido: ' . ($_POST['id'] ?? 'no definido'));
    }
