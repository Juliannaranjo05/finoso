<?php
/**
 * APROBAR PAGO - Notificación WhatsApp
 * 
 * Este archivo aprueba un pago y envía notificación al cliente
 */
...
try {
    ...
    $sql_update = "UPDATE orden SET estado = 'aprobado' WHERE id_orden = ?";
    ...
    try {
        if (verificarConfiguracionTwilio()) {
            ...
            $resultado = $whatsapp->enviarMensaje($telefono, $mensaje, 'pago_aprobado');
