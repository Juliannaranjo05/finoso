...
(1, 'Richard Mille', 'Rchrd Mll Calavera Blanco Circones Negros-Dorados', 'Diseño de calavera esqueleto con incrustaciones de circones negros y bisel dorado ionizado. Correa de acero pulido.', 135000.00, 0.11, 'img/Rchrd Mll Calavera Blanco Circones Negros-Dorados.png', 1, 0),
(2, 'Patek Philippe', 'Patk Phlppe Bicolor Dorado - Negro', 'Clásico bicolor con brazalete alternado en baño de oro y acero pulido. Tablero negro con marcadores luminiscentes y fechador a las 3', 125000.00, NULL, 'img/Patk Phlppe Bicolor Dorado - Negro.png', 1, 0),
(3, 'Technomarine', 'Tchmrn Mujer Circones Negro Tablero Negro-Dorado', 'Diseño elegante de tablero negro mate con bisel dorado ionizado e incrustaciones de circones facetados de alta pureza', 115000.00, 0.16, 'img/Tchmrn Mujer Circones Negro Tablero Negro-Dorado.png', 1, 0),
(4, 'Q&Q', 'Q&Q hombre Bazel Plateado Tablero Blanco-Plateado', 'Bazeleado plateado en acero cromado, tablero blanco con subesferas decorativas y marcadores luminiscentes', 100000.00, NULL, 'img/Q&Q hombre Bazel Plateado Tablero Blanco-Plateado.png', 1, 0);
